...
This capability defines the WebGL tunnel scene — a fullscreen 3D flythrough rendered via React Three Fiber (R3F) on the home page. It specifies the visual composition, camera setup, animation loop, shader fidelity, and initial render state required to match the legacy Three.js implementation.
