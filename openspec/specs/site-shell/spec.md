...
The site-shell capability defines the foundational application shell for the new
`toki-website` app — the Next.js App Router structure, persistent 3D canvas
layer, build configuration, and base visual baseline that all future features are
built on top of.
