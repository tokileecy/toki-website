...
void main()
{
  ...
  vec2 uvs[5];
  uvs[0] = uv + vec2(1.0 * sin(Period * uv.y + 5.0 * time) , ShakeRange * sin(Period * uv.x + 5.0 * time));
  uvs[1] = uv + vec2(1.0 * sin(Period * uv.y + 1.047 * time) , ShakeRange * sin(Period * uv.x + 3.142 * time));
  uvs[2] = uv + vec2(1.0 * sin(Period * uv.y - 3.0 * time) , ShakeRange * sin(Period * uv.x + 3.66 * time));
  uvs[3] = uv + vec2(1.0 * sin(Period * uv.y + 2.094 * time) , ShakeRange1 * sin(Period * uv.x - 1.571 * time));
  uvs[4] = uv + vec2(1.0 * sin(Period * uv.y - 0.555 * time) , ShakeRange1 * sin(Period * uv.x - 2.1111 * time));
